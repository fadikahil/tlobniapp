                            ...
                            <div class="card-body mt-3">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="question" id="question" class="form-control" placeholder="{{__('Enter Question here')}}">
                                    </div>
                                    <div class="col-md-12">
                                        <label for="answer" class="mandatory form-label">{{ __('Answer') }}</label>
                                        <textarea name="answer" id="answer" class="form-control" cols="10" rows="5" placeholder="{{__('Enter your answer here')}}"></textarea>
                                    </div>
                            ...
                            <div class="col-12">
                                <table class="table-light table-striped" aria-describedby="mydesc" id="table_list"
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" data-field="answer" data-sortable="false">{{__('Answers')}}</th>
