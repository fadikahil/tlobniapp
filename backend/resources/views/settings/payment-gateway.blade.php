                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-sm-2 col-md-12 col-xs-12  mt-2">
                                    <div class="form-check form-switch ">
                                        ...
                                        <input class="form-check-input switch-input status-switch" type="checkbox" role="switch" name='op' {{ isset($paymentGateway["Stripe"]['status']) && $paymentGateway["Stripe"]['status'] == '1' ? 'checked' : '' }} id="switch_stripe_gateway" aria-label="switch_stripe_gateway" checked>
                                    </div>
                                </div>
